/**
  ...
  * @brief   Function to initialize the ADC
	* 10.10.2016	Nils Schoenherr: structure/Doxygen
  *******************************************************************
  */
...
__IO  uint32_t ADC3ConvertedValue;
	...
	/**
  * @brief  Initializes ADC3 channel07 with DMA configuration
  * @param  None
  * @retval None
  */
void ADC3_CH7_DMA_Config(void)
{
 ...
 /* Enable DMA request after last transfer (Single-ADC mode) */
  ...
  ADC_SoftwareStartConv(ADC3);
	...
	/**
  * @brief  Getter for current ADC Value of ADC3 channel 7
  * @param  None
  * @retval ADCvalue
  */
