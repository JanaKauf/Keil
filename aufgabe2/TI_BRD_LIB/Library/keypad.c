...
//--------------------------------------------------
  ...
  //---------------------------------------------
  TFT_touch_area_font_color( GREEN,BLACK );      // define color for touch font
  TFT_touch_area_font(SWISS30B);                  // set font for touch area
  TFT_touch_area_frame(20,0);                     //set border no. 20
  TFT_touch_area_color(BLACK,GREEN,BLACK, GREEN,BLACK,GREEN);     //set border colors normal and for selection
